import {ITrafficResponse, ITrafficService} from './traffic-service.types';

export class TrafficMeisterApi implements ITrafficService {
  ...
  public fetchData(cb: (error: string | null, data?: ITrafficResponse[]) => void) {
    if (!cb) {
